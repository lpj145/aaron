...
```rust
use aaron_core::{Store, KeyspaceExt, ScanOptions};

fn main() -> Result<(), aaron_core::BoxError> {
...
```rust
use aaron_core::{Store, KeyspaceExt};
