...
/// Unified lifecycle events emitted by the SWIM membership service onto [`aaron_core::EventHub`].
...
pub struct JoinClusterCommand {
    ...
    pub cluster_id: Option<aaron_core::Uuid>,
}

impl JoinClusterCommand {
    /// Creates a new `JoinClusterCommand`.
    pub fn new(seed_addr: std::net::SocketAddr, cluster_id: Option<aaron_core::Uuid>) -> Self {
        Self {
            seed_addr,
            cluster_id,
        }
