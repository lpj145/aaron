...
pub enum MembershipError {
    ...
    ClusterMismatch {
        local: aaron_core::Uuid,
        remote: aaron_core::Uuid,
    },
...
impl From<aaron_core::Error> for MembershipError {
    fn from(source: aaron_core::Error) -> Self {
