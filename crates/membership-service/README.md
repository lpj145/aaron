...
use node::{service_fn, Context, Node, Uuid};
use tracing::info;
...
use node::{EventHub, Uuid};
use membership_service::{JoinClusterCommand, MembershipHandle};
...
async fn join_via_handle(handle: &MembershipHandle, seed: SocketAddr) -> Result<(), node::BoxError> {
